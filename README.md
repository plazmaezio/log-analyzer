...
**Analysis Modes (`AnalysisMode`):** The modes `MODE_SECURITY`, `MODE_PERFORMANCE`, `MODE_TRAFFIC` and `MODE_FULL` allow filtering events by category using bitwise OR operator.
